...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO user (ID_USER,USERNAME,EMAIL) 
    ...
    if($result){
        echo "<script>alert('Data berhasil ditambahkan!');window.location='data-pembeli.php';</script>";  
    } else {
        echo "<script>alert('Data gagal ditambahkan!');window.location='data-pembeli.php';</script>";  
    }
}
