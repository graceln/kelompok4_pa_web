...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content">
                <h2>DATA MENU</h2>
                <hr><br>
                <button class="btn"><a href="tambah-menu.php" class="btn">Tambah</a></button><br><br>
                        ...
                        <tbody>
                            ...
                            while($d = mysqli_fetch_array($data)){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="edit"><a href="ubah-menu.php?ID_MENU=<?php echo $d['ID_MENU']; ?>" class="edit">Ubah</a></button>
                                        <button class="hapus"><a href="hapus-menu.php?ID_MENU=<?php echo $d['ID_MENU']; ?>" onclick="return confirm('Anda yakin hapus data ini?')"
